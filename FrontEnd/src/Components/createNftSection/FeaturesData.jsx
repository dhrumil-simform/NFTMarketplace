...
const dataFeature = [
  {
    ...
    title: 'wallets',
    content:
      'Once you’ve set up your wallet of choice, connect it to OpenSea by clicking the wallet icon in the top right corner. Learn more about the wallets.',
  },
  {
    icon: 'i',
  ...
  },
  {
    ...
    title: 'List for sale',
    content:
      'Choose between auctions, fixed-price, and declining-price listings. You choose how you want to sell your NFTs, and we help you sell them!',
  },
]
